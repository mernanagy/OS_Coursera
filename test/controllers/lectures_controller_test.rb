...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should update lecture" do
    patch :update, id: @lecture, lecture: { attachment: @lecture.attachment, content: @lecture.content, course_id: @lecture.course_id, title: @lecture.title, user_id: @lecture.user_id }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
